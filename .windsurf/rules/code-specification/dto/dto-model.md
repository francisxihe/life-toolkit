...
export class EntityDto extends IntersectionType(
  ...
  exportVo(): EntityVO.EntityVo {
    return {
      ...
      // 日期统一格式化
      // planDate: this.planDate ? dayjs(this.planDate).format("YYYY-MM-DD") : undefined,
      // completedAt: this.completedAt ? dayjs(this.completedAt).format("YYYY-MM-DD HH:mm:ss") : undefined,
      // 关联对象可按需转换/简化
