...
export class TodoRepository {
  ...
  async create(createTodoDto: CreateTodoDto): Promise<TodoDto> {
    const todo = this.todoRepository.create({
      ...
      planDate: createTodoDto.planDate ? dayjs(createTodoDto.planDate).format('YYYY-MM-DD') : undefined,
    });
  ...
  private buildWhere(filter: TodoPageFilterDto | TodoFilterDto): FindOptionsWhere<Todo> {
