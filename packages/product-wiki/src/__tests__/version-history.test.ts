...
const history: ProductChangeLog = {
  changes: [
    {
      version: 'v0.2.0', date: '2026-07-29', event: 'changed', summary: '调整待办模块。', productStatus: 'roadmap', surfaceCoverage: 'complete',
      feature: { key: moduleKey, scope: 'module', moduleId: 'growth.todo', moduleTitle: '待办管理', name: '待办管理' },
    },
    {
      version: 'v0.10.0', date: '2026-07-29', event: 'changed', summary: '再次调整待办模块。', productStatus: 'roadmap', surfaceCoverage: 'complete',
      feature: { key: moduleKey, scope: 'module', moduleId: 'growth.todo', moduleTitle: '待办管理', name: '待办管理' },
    },
    {
      version: 'v0.1.0', date: '2026-07-28', event: 'baseline', summary: '建立标题字段。', productStatus: 'roadmap', surfaceCoverage: 'complete',
      feature: { key: fieldKey, scope: 'field', moduleId: 'growth.todo', moduleTitle: '待办管理', name: '标题', parentName: '待办' },
    },
    {
      version: 'v0.1.0', date: '2026-07-30', event: 'removed', summary: '移除旧标题字段。', productStatus: 'deprecated', surfaceCoverage: 'none',
      feature: { key: fieldKey, scope: 'field', moduleId: 'growth.todo', moduleTitle: '待办管理', name: '标题', parentName: '待办' },
    },
  ],
};
