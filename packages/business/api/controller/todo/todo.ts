...
export default class TodoController {
  ...
  static async list(params: TodoVO.TodoListFiltersVo) {
  ...
  static async listWithRepeat(params: TodoVO.TodoListFiltersVo) {
    return request<TodoVO.TodoListVo>({ method: "get" })(`/todo/listWithRepeat`, params);
  }

  static async detailWithRepeat(id: string) {
    return request<TodoVO.TodoVo>({ method: "get" })(`/todo/detailWithRepeat/${id}`);
  }
}
