...
console.log(`2024-01-01 是工作日吗? ${(0, index_1.isWorkday)('2024-01-01')}`); // false (元旦)
console.log(`2024-01-02 是工作日吗? ${(0, index_1.isWorkday)('2024-01-02')}`); // true
console.log(`2024-01-01 是节假日吗? ${(0, index_1.isHoliday)('2024-01-01')}`); // true (元旦)
console.log(`2024-02-04 是补班日吗? ${(0, index_1.isMakeupDay)('2024-02-04')}`); // true (春节补班)
console.log();
// 2. 获取详细日期信息
console.log('2. 详细日期信息:');
const dateInfo = (0, index_1.getDateInfo)('2024-01-01');
...
// 6. 获取补班日
console.log('6. 补班日信息:');
const makeupDays2024 = (0, index_1.getMakeupDaysInYear)(2024);
console.log(`2024年补班日: ${makeupDays2024.join(', ')}`);
console.log();
// 7. 年度统计
console.log('7. 年度统计:');
const yearStats = (0, index_1.getYearStatistics)(2024);
console.log('2024年统计:', {
...
// 8. 月度统计
console.log('8. 月度统计:');
const monthStats = (0, index_1.getMonthStatistics)(2024, 1);
...
// 9. 工作日计算
console.log('9. 工作日计算:');
const nextWorkday = (0, index_1.getNextWorkday)('2024-01-01');
const prevWorkday = (0, index_1.getPreviousWorkday)('2024-01-01');
const workdayCount = (0, index_1.getWorkdaysBetween)('2024-01-01', '2024-01-31');
...
const calendar = new index_1.ChineseCalendar();
...
specialDates.forEach(date => {
    ...
    let description = '';
    switch (info.type) {
        case index_1.DateType.WORKDAY:
            description = '工作日';
            break;
        case index_1.DateType.WEEKEND:
            description = '周末';
            break;
        case index_1.DateType.HOLIDAY:
            description = `节假日 (${info.holiday?.Name})`;
            break;
        case index_1.DateType.MAKEUP_DAY:
            description = '补班日';
            break;
    }
