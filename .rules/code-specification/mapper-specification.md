...
vo.createdAt = dto.createdAt
  ...
  : "";
vo.startDate = dto.startDate ? dayjs(dto.startDate).format("YYYY-MM-DD") : "";
...
vo.endDate = dto.endDate ? dayjs(dto.endDate).format("YYYY-MM-DD") : undefined;
